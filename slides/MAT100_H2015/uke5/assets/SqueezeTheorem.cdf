...
NotebookDataLength[     77080,       1585]
NotebookOptionsPosition[     50041,       1004]
NotebookOutlinePosition[     76282,       1565]
CellTagsIndexPosition[     76171,       1559]
WindowTitle->Squeeze Theorem
WindowFrame->Normal*)
...
Cell["Squeeze Theorem", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`i$$ = 0, $CellContext`n$$ = 1, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`n$$], 1}, {0, 1, 2, 3}}, {{
       Hold[$CellContext`i$$], 0, "zoom"}, 0, 3}}, Typeset`size$$ = {
    550., {198., 202.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`n$18864$$ = 
    0, $CellContext`i$18865$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`i$$ = 0, $CellContext`n$$ = 1}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$18864$$, 0], 
        Hold[$CellContext`i$$, $CellContext`i$18865$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Plot[{$CellContext`x^$CellContext`n$$ Sin[1/$CellContext`x], 
         Abs[$CellContext`x^$CellContext`n$$], -
         Abs[$CellContext`x^$CellContext`n$$]}, {$CellContext`x, \
-10^(-$CellContext`i$$), 10^(-$CellContext`i$$)}, 
        PlotStyle -> {Black, {Thick, Red}, {Thick, Blue}}, MaxRecursion -> 8, 
        ImagePadding -> {{10, 10}, {10, 50}}, PlotLabel -> TraditionalForm[
          Row[{
            Style[-Abs[$CellContext`x^$CellContext`n$$], Blue], 
            " \[LessEqual] ", $CellContext`x^$CellContext`n$$ 
            Sin[1/$CellContext`x], " \[LessEqual] ", 
            Style[
             Abs[$CellContext`x^$CellContext`n$$], Red]}]], 
        ImageSize -> {550, 400}], 
      "Specifications" :> {{{$CellContext`n$$, 1}, {0, 1, 2, 
         3}}, {{$CellContext`i$$, 0, "zoom"}, 0, 3}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{595., {254., 259.}},
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"sin", "(", 
     FractionBox["1", "x"], ")"}], "=", "1"}], TraditionalForm]], 
  "InlineMath"],
 " and some for which ",
 Cell[BoxData[
  FormBox[
...
Cell[TextData[{
 ButtonBox["Calculus with ",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://library.wolfram.com/infocenter/Books/5222/"], None}],
 StyleBox[ButtonBox["Mathematica",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://library.wolfram.com/infocenter/Books/5222/"], None}],
  FontSlant->"Italic"],
 ButtonBox[": An Interactive Book",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://library.wolfram.com/infocenter/Books/5222/"], None}],
 " (",
...
SqueezeTheorem&version=0010"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/SqueezeTheorem/SqueezeTheorem-source.\
...
Cell[TextData[{
 "\"",
 ButtonBox["Squeeze Theorem",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SqueezeTheorem/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SqueezeTheorem/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/SqueezeTheorem/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/SqueezeTheorem/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/SqueezeTheorem/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Bruce Atwood",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Bruce+Atwood"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Bruce+Atwood"],
 " (Beloit College)"
}], "Author",
...
Cell[TextData[{
 "After work by: ",
 ButtonBox["Selwyn Hollis",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Selwyn+Hollis"],
     None}],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40669, 764, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40930, 773, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49219, 979, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75886, 1548},
 {"Copyright", 76080, 1553}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[579, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34910, 590, 36, 0, 70, "DemoTitle"],
Cell[34949, 592, 2436, 49, 70, "Output",
 CellID->149498675],
Cell[37388, 643, 3278, 119, 70, "ManipulateCaption"],
Cell[40669, 764, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40930, 773, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41624, 790, 44, 0, 70, "RelatedLinksSection"],
Cell[41671, 792, 731, 23, 70, "RelatedLinks",
 CellID->77536243],
Cell[42405, 817, 574, 20, 70, "RelatedLinks",
 CellID->1270953065],
Cell[42982, 839, 4781, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47766, 930, 45, 0, 70, "CitationSection"],
Cell[47814, 932, 748, 20, 70, "Citations"],
Cell[48565, 954, 346, 11, 70, "Author"],
Cell[48914, 967, 302, 10, 70, "Author",
 CellID->2035810393],
Cell[49219, 979, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature jSqgp64PIEAxRw7Rq7icMHhI *)
